            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    TimeIntervalIds = table.Column<List<int>>(type: "integer[]", nullable: true),
                    BookingIds = table.Column<List<int>>(type: "integer[]", nullable: true),
                    OpenTimeId = table.Column<int>(type: "integer", nullable: false),
                    TimeLease = table.Column<int>(type: "integer", nullable: false),
                    Increment = table.Column<byte>(type: "smallint", nullable: true),
                    OrginisationIds = table.Column<List<int>>(type: "integer[]", nullable: false)
                },
                constraints: table =>
                {
